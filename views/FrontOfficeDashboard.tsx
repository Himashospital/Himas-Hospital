                  ...
                  <td className="p-5">
                    {activeTab === 'APPOINTMENTS' ? (
                      <div className="flex items-center gap-2">
                         ...
                         <span className="text-[8px] text-slate-400 font-black uppercase tracking-widest">{item.bookingType === 'Follow Up' ? 'Follow-Up' : item.status}</span>
                      </div>
                    ) : (
